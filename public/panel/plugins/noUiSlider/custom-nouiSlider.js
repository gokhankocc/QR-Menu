...
// Display the sliders value and how far the handle moved
// from the left edge of the sliders.
...
// Store the locked state and sliders values.
...
function crossUpdate ( value, slider ) {
    ...
    // the other sliders value.
    var a = slider1 === slider ? 0 : 1, b = a ? 0 : 1;

    // Offset the sliders value.
...
// The value will be send to the other sliders,
// using a custom function as the serialization
// method. The function uses the global 'lockedState'
// variable to decide whether the other sliders is updated.
