            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('admin.services.update',$services->id) }}" method="post" id="mainForm"
                                            ...
                                            <div class="tab-pane fade  @if($key == 'tr')  show active @endif" id="underline-{{ $key }}" role="tabpanel" aria-labelledby="underline-{{ $key }}-tab"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_title[{{ $key }}]" value="{{$services->getTranslation('meta_title',$key)}}"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_og_title[{{ $key }}]" value="{{$services->getTranslation('meta_og_title',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_description[{{ $key }}]" value="{{$services->getTranslation('meta_description',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_og_url[{{ $key }}]" value="{{$services->getTranslation('meta_og_url',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_og_image[{{ $key }}]" value="{{$services->getTranslation('meta_og_image',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_og_type[{{ $key }}]" value="{{$services->getTranslation('meta_og_type',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_canonical[{{ $key }}]" value="{{$services->getTranslation('meta_canonical',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_keywords[{{ $key }}]" value="{{$services->getTranslation('meta_keywords',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_author[{{ $key }}]" value="{{$services->getTranslation('meta_author',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="meta_og_description[{{ $key }}]" value="{{$services->getTranslation('meta_og_description',$key)}}"
                                                                   class="form-control @error('name') is-invalid @enderror"
                                                            >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="t-text" type="text" name="name[{{$key}}]"
                                                           class="form-control @error('name') is-invalid @enderror"
                                                           value="{{$services->getTranslation('name',$key)}}" >
                                                    @error('name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    >{{$services->getTranslation('text',$key)}}</textarea>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
