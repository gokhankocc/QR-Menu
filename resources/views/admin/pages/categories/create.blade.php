            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('admin.categories.store') }}" method="post" id="mainForm"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control basic" name="parent_category_id">
                                            ...
                                            {{--@php
                                                $lastCategory = $categories->last(); // Son eklenen kategoriyi al
                                                $parentCategoryId = $lastCategory ? $lastCategory->parent_category_id : 0;
                                            @endphp
                                            @foreach($categories as $category)
                                                ...
                                                @endphp
                                                <option value="{{$category->id}}" {{ $category->id == $parentCategoryId ? 'selected' : '' }}>{!! $displayPath !!}</option>
                                            @endforeach--}}
                                        </select>
                                    ...
                                    <div class="tab-content" id="lineTabContent-3">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="t-text" type="text" name="name[{{ $key }}]"
                                                                   class="form-control {{$key}} @error('text') is-invalid @enderror"
                                                                   required>
                                                            @error('text')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                        ...
                                        @endforeach
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <p>Sıra Numarası</p>
                                                    <input id="t-text" type="number" name="rank"
