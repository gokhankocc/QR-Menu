            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('admin.products.update',$product->id) }}" method="post" id="mainForm"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                <p>Sıra Numarası</p>
                                                <input id="t-text" type="number" name="rank" value="{{$product->rank}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="summernote {{$key}}" name="text[{{ $key }}]">{{$product->getTranslation('text',$key)}}</textarea>
                                                            @error('details')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
