<head>
    ...
    <title>Cajun Corner Yönetim Paneli</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{--{{ asset('/panel/assets/img/ays-logo.png') }}--}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/panel/plugins/select2/select2.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/panel/assets/css/forms/theme-checkbox-radio.css')}}">

    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
    <link href="{{ asset('/panel/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css')}}">
    <link href="{{ asset('/panel/assets/css/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('/panel/assets/css/dashboard/dash_2.css')}}" rel="stylesheet" type="text/css" />
    <style>
        .widget-content-area{
